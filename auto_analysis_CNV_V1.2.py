...
def prepare_do_anlysis(new_dem_do_anlysis_path,email):
    ...
    for dem_02 in new_dem_do_anlysis_path.keys():
        ...
        try:
            ...
            os.system("cd {dir} && python3 /data/software/bioinfo_practical_applications/auto_analysis_CNV/auto_only_CNV/get_project_info_list_for_CNV_V1.4.4.py --samplesheet_path {csv}".format(dir=run_id_CNV_dir,csv=str(new_dem_do_anlysis_path[dem_02]['csv'])))
